...
var lastTime = 0;
var updating = function (deltaTime) {
...
function initsnow() {
    ...
    for (var i = 0; i <= snowmax; i++) {
        ...
        snow[i] = document.getElementById("s".concat(i));
...
for (var i = 0; i <= snowmax; i++) {
    document.write("<span id='s".concat(i, "' style='position:absolute;top:-").concat(snowmaxsize, "px;'>").concat(snowletter, "</span>"));
}
if (browserok) {
